...
summary(lrqap)
```
x1 is gg rubbing, estimate = -0.1161796 is beta 1, intercept = 0.8507548 is beta 0
when an individual's rank is 0, the predicted weight of a tie for gg rubbing is -0.1 - this makes no sense but it doesn't matter because the model is not significant
...
rank of receiver is even less predictive of intensity of GG rubbing, nd we know this based on [...]
